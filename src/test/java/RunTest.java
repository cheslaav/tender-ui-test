...
@CucumberOptions(
        ...
        tags = "@dockerTest", //фичам и даже отдельным сценариям можно присваивать тэги; данный параметр указывает какие именно тесты будут запущены. Тэги записываются в строчку через запятую: “@smoketest, @alltests, @special”
